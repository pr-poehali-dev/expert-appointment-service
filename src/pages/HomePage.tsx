...
const specialists = [
  { name: "Анна Соколова", specialty: "Кардиолог", experience: "12 лет", rating: 4.9, reviews: 284, available: true, emoji: "🫀" },
  { name: "Михаил Громов", specialty: "Невролог", experience: "8 лет", rating: 4.8, reviews: 196, available: true, emoji: "🧠" },
  { name: "Елена Петрова", specialty: "Терапевт", experience: "15 лет", rating: 5.0, reviews: 421, available: false, emoji: "🩺" },
  { name: "Дмитрий Волков", specialty: "Хирург", experience: "20 лет", rating: 4.9, reviews: 338, available: true, emoji: "🔬" },
];
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="flex items-end justify-between mb-8">
            ...
            <button className="text-primary text-sm font-medium hover:opacity-80 transition-opacity flex items-center gap-1">
              Все врачи <Icon name="ArrowRight" size={14} />
            </button>
          </div>
